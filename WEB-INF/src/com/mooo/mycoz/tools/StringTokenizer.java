 ...
 * Inc.,  Franklin St, Fifth Floor, Boston, MA 02110- USA.
 *
 * Please contact Sun Microsystems, Inc.,  Network Circle, Santa Clara,
 * CA  USA or visit www.sun.com if you need additional information or
 * have any questions.
 */
 ...
 * <ul>
 * <li>If the flag is <code>false</code>, delimiter characters serve to separate
 * tokens. A token is a maximal sequence of consecutive characters that are not
 * delimiters.
 * <li>If the flag is <code>true</code>, delimiter characters are themselves
 * considered to be tokens. A token is thus either one delimiter character, or a
 ...
 * anyone seeking this functionality use the <tt>split</tt> method of
 * <tt>String</tt> or the java.util.regex package instead.
 * <p>
 * The following example illustrates how the <tt>String.split</tt> method can be
 * used to break up a string into its basic tokens: <blockquote>
 * 
 * <pre>
...
public class StringTokenizer implements Enumeration<Object> {
	 ...
	 * hasSurrogates is true and the tokenizer uses the different code path.
	 * This is because String.indexOf(int) doesn't handle unpaired surrogates as
	 * a single character.
	 */
	 ...
	 * isDelimiter(int) is used to determine if the given codepoint is a
	 * delimiter.
	 */
