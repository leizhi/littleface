...
<link type="text/css" rel="stylesheet" href="jsp/styles/mainMenu.css" />
...
<body>
<form name="default" Method="Post" action="<%=request.getContextPath()%>/User.do?state=processLogin">
<%@ include file="/jsp/incl/winHeader.jsp" %>
<%--
<div class="text" >
<table border="0" cellspacing="0" cellpadding="1" width="100%" bgcolor="#ffffff" id="small">
<tr width="100%">
 <td ><label >Thanks From Here. Good Bye!</label></td>
</tr>
</table>
...
<tr width="100%">
 ...
 <td width="90%"><input type="text" id="UserName" name="UserName" size="15" maxlength="255"/></td>
</tr>
<tr width="100%">
 <td width="10%"><label >Password:</label></td>
 <td width="90%"><input type="password" id="Password" name="Password" size="15" maxlength="255"/></td>
</tr>
...
--%>
<div id="content">
<div class="title"><p>Thanks From Here. Good Bye!</p></div>
<div class="cbody">
