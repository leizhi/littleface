...
<body>
<form id="default" name="default" method="Post" action="<%=request.getContextPath()%>/AccountGroup.do" >
...
<!-- SearchTable -->
	...
	<li class="Input"><html:input type="text" id="ID" name="ID" property="ID" size="15" maxlength="255"/></li>
        ...
        <li class="Input"><html:input type="text" id="Code" name="Code" property="Code" size="15" maxlength="255"/></li>
     	...
     	<li class="Output" id="flag"><html:message key="Type" /> </li>
        <li class="Input"><html:input type="text" id="Type" name="Type" property="Type" size="15" maxlength="255"/></li>
        ...
        <li class="Input"><html:input type="text" id="Description" name="Description" property="Description" size="15" maxlength="255"/></li>
     	...
     	<li class="Button"><input type="button" id="Find" name="Find" value="Find" onclick="Util.Submit('/AccountGroup.do?state=list');"/><input type="button" id="Add" name="Add" value="Add" onclick="Util.Submit('/AccountGroup.do?state=promptAdd');"/><input type="reset" id="reset" name="reset" value="reset"/></li>
      </ul>
    </div>
...
<!-- ListTable -->
    <div class="Table5" >
      <ul>
     	...
     	<li class="Title"><html:message key="Type" /></li>
...
<logic:iterate property="List">
        ...
        <li><%=Input.getValue("Type"+i)%></li>
        <li><%=Input.getValue("Description"+i)%></li>

        <li><a href="javascript:Util.Submit('/AccountGroup.do?state=promptUpdate&Key=<%=Input.getValue("ID"+i)%>');"><html:message key="Update" /></a> <a href="javascript:Util.Submit('/AccountGroup.do?state=processDelete&Key=<%=Input.getValue("ID"+i)%>');"><html:message key="Delete" /></a></li>
<% i++; %>
</logic:iterate>
