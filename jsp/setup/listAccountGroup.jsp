...
<!-- SearchTable -->
	...
	<li class="Input"><input type="text" id="ID" name="ID" property="ID" size="15" maxlength="255"/></li>
        ...
        <li class="Input"><input type="text" id="Code" name="Code" property="Code" size="15" maxlength="255"/></li>
     	...
     	<li class="Output" id="flag"><fmt:message key="Type" /> </li>
        <li class="Input"><input type="text" id="Type" name="Type" property="Type" size="15" maxlength="255"/></li>
...
<!-- ListTable -->
    <div class="Table5" >
      <ul>
     	...
     	<li class="Title"><fmt:message key="Type" /></li>
...
<logic:iterate property="List">
        ...
        <li><a href="javascript:Util.Submit('/AccountGroup.do?state=promptUpdate&Key=<%=Input.getValue("ID"+i)%>');"><fmt:message key="Update" /></a> <a href="javascript:Util.Submit('/AccountGroup.do?state=processDelete&Key=<%=Input.getValue("ID"+i)%>');"><fmt:message key="Delete" /></a></li>
<% i++; %>
</logic:iterate>
