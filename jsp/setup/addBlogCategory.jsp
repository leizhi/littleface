...
<meta name="revision" content="$Id: addBlogCategory.jsp,v 1.2 2008/07/16 00:30:41 cvs Exp $" />
...
<form id="default" name="default" Method="post" action="<%=request.getContextPath()%>/BlogCategory.do?state=processAdd">
