...
<body>
<form name="default" Method="Post" action="<%=request.getContextPath()%>/AccountExtension.do?state=promptAdd">
...
<!-- AddTable -->
	...
	<li class="AddInput"><html:input type="text" id="Code" name="Code" property="Code" size="15" maxlength="255"/></li>
        ...
        <li class="AddInput"><html:input type="text" id="Description" name="Description" property="Description" size="15" maxlength="255"/></li>
     	...
     	<li class="Button"><input type="button" id="Add" name="Add" value="Add" onclick="Util.Submit('/AccountExtension.do?state=processAdd');"/><input type="reset" id="reset" name="reset" value="reset"/></li>
      </ul>
    </div>
