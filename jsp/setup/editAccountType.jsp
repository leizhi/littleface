...
<!-- UpdateTable -->
	...
	<li class="AddInput"><html:select id="Category" name="Category" property="Category" /></li>
        ...
        <li class="AddInput"></li>
     	...
     	<li class="Button"><input type="button" id="Update" name="Update" value="Update" onclick="Util.Submit('/AccountType.do?state=processUpdate');"/><input type="button" id="Update" name="Update" value="Update" onclick="Util.Submit('/AccountType.do?state=processUpdate');"/></li>
      </ul>
    </div>
