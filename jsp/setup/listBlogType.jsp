...
<logic:iterate property="List">
	...
	<li><%=Input.getValue("Name"+i)%></li>
        ...
        <li><a href="javascript:Util.Submit('/BlogType.do?state=promptUpdate&Key=<%=Input.getValue("ID"+i)%>');"><html:message key="Update" /></a> <a href="javascript:Util.Submit('/BlogType.do?state=processDelete&Key=<%=Input.getValue("ID"+i)%>');"><html:message key="Delete" /></a></li>
<% i++; %>
</logic:iterate>
