...
<!-- SearchTable -->
	...
	<li class="Input"><input type="text" id="Category" name="Category" property="Category" size="15" maxlength="255"/></li>
        ...
        <li class="Input"></li>
     	...
     	<li class="Button"><input type="button" id="Find" name="Find" value="Find" onclick="Util.Submit('/AccountType.do?state=list');"/><input type="button" id="Add" name="Add" value="Add" onclick="Util.Submit('/AccountType.do?state=promptAdd');"/><input type="reset" id="reset" name="reset" value="reset"/></li>
      </ul>
    </div>
...
<logic:iterate property="List">
        ...
        <li><%=Input.getValue("NoteType"+i)%></li>
