...
<body>
<form id="default" name="default" method="Post" action="<%=request.getContextPath()%>/AccountCategory.do" >
...
<!-- SearchTable -->
	...
	<li class="Input"></li>
     	...
     	<li class="Button"><input type="button" id="Find" name="Find" value="Find" onclick="Util.Submit('/AccountCategory.do?state=list');"/><input type="button" id="Add" name="Add" value="Add" onclick="Util.Submit('/AccountCategory.do?state=promptAdd');"/><input type="reset" id="reset" name="reset" value="reset"/></li>
      </ul>
    </div>
<!-- ListTable -->
    <div class="Table" >
...
<logic:iterate property="List">
	...
	<li><%=Input.getValue("Code"+i)%></li>
        ...
        <li><a href="javascript:Util.Submit('/AccountCategory.do?state=promptUpdate&Key=<%=Input.getValue("ID"+i)%>');"><html:message key="Update" /></a> <a href="javascript:Util.Submit('/AccountCategory.do?state=processDelete&Key=<%=Input.getValue("ID"+i)%>');"><html:message key="Delete" /></a></li>
<% i++; %>
</logic:iterate>
