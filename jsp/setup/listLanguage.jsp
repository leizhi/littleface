...
<logic:iterate property="List">
	...
	<li><%=Input.getValue("Name"+i)%></li>
        ...
        <li><a href="javascript:Util.Submit('/Language.do?state=promptUpdate&Key=<%=Input.getValue("ID"+i)%>');"><fmt:message key="Update" /></a> <a href="javascript:Util.Submit('/Language.do?state=processDelete&Key=<%=Input.getValue("ID"+i)%>');"><fmt:message key="Delete" /></a></li>
<% i++; %>
</logic:iterate>
