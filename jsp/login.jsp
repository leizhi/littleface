...
<div style="float: left;width: 59%;text-align: left;"><input type="text" name="user.name" size="15" maxlength="30"></div>
<div style="clear: both;"></div>
</div>

<div style="width: 100%;">
<div style="float: left;width: 40%;text-align: right;"><fmt:message key="Password"/>:</div>
<div style="float: left;width: 59%;text-align: left;"><input type="password" name="user.password" size="15" maxlength="30"></div>
<div style="clear: both;"></div>
</div>
