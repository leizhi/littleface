...
<meta name="revision" content="$Id: addDownload.jsp,v 1.6 2008/09/03 22:30:19 cvs Exp $" />
...
<form id="default" name="default" Method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/Download.do?state=processAdd">
...
<tr>
<td><html:message key="File" /></td>
<td><html:input type="file" id="DownloadPath" name="DownloadPath" property="DownloadPath"/></td>
</tr>

<tr>
<td><html:message key="Image" /></td>
<td><html:input type="file" id="ImagePath" name="ImagePath" property="ImagePath"/></td>
</tr>

<tr>
<td><html:message key="DownloadDate" /></td>
