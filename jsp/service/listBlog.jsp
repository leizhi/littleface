...
<meta name="revision" content="$Id: listBlog.jsp,v 1.3 2008/09/07 21:36:56 cvs Exp $" />
...
<logic:iterate property="ListBlog">
		...
		<tr>
			...
			<td><html:write property="<%="Popularity"+i%>"/></td>
			<td>&nbsp<a href="<%=request.getContextPath()%>/Blog.do?state=joinBlog&Key=<html:write property="<%="ID"+i%>"/>">OK</a></td>
			<td>&nbsp<a href="<%=request.getContextPath()%>/Blog.do?state=promptUpdateBlog&Key=<html:write property="<%="ID"+i%>"/>">OK</a></td>
		</tr>
<% i++; %>
</logic:iterate>
	</tbody>
