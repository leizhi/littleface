...
<meta name="revision" content="$Id: listDownload.jsp,v 1.9 2008/08/31 13:35:50 zlei Exp $" />
...
<logic:iterate property="List">
		...
		<tr>
			...
			<td><html:write property="<%="FileLength"+i%>"/></td><td><a href="<html:write property="<%="DownloadPath"+i%>"/>">OK</a></td>
			<td>&nbsp<a href="<%=request.getContextPath()%>/Download.do?state=promptUpdate&Key=<html:write property="<%="ID"+i%>"/>">OK</a></td>
		</tr>
<% i++; %>
</logic:iterate>
	</tbody>
