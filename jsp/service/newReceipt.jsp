...
<!-- SearchTable -->
	...
	<li class="Input"> <html:output property="NoteNo"/> <input type="hidden" id="NoteNo" name="NoteNo" property="NoteNo"/></li>
        ...
        <li class="Input"><html:output property="AccountToCredit" /> <input type="hidden" id="AccountToCredit" name="AccountToCredit" property="AccountToCredit"/></li>
        ...
        <li class="Input"><html:output property="AccountToDebit" /> <input type="hidden" id="AccountToDebit" name="AccountToDebit" property="AccountToDebit"/></li>
     	<li class="Output"><fmt:message key="AmountToDebit" /></li>
        <li class="Input"><input type="text" id="AmountToDebit" name="AmountToDebit" property="AmountToDebit" size="15" maxlength="255"/></li>
