...
<!-- SearchTable -->
	...
	<li class="Input"><html:input type="text" id="JobID" name="JobID" property="JobID" size="15" maxlength="255"/></li>
     	<li class="Output"><html:message key="NoteNo" /></li>
	<li class="Input"><html:output id="NoteNo" name="NoteNo" property="NoteNo"/>	<html:input type="hidden" id="NoteNo" name="NoteNo" property="NoteNo"/></li>
        ...
        <li class="Input"> <html:input type="text" id="DueDate" name="DueDate" property="DueDate" size="15" maxlength="255"/> <a href="javascript:Util.Calendar('DueDate')"><img src="jsp/etc/images/miniDate.gif" border=0 alt="<html:message key="ChooseDate"/>"></a></li>
...
<!-- ListTable -->
    <div class="Table7" >
      <ul>
     	...
     	<li class="Title"><html:message key="Item Name" /></li>
     	<li class="Title"><html:message key="Charge Rate" /></li>
     	<li class="Title"><html:message key="Unit" /></li>
     	<li class="Title"><html:message key="Quantity" /></li>
     	<li class="Title"><html:message key="Bill Amount" /></li>
     	...
     	<li><html:input type="text" id="ItemName" name="ItemName" property="ItemName" size="10" maxlength="255"/></li>
     	<li><html:input type="text" id="ItemRate" name="ItemRate" property="ItemRate" size="10" maxlength="255" onchange="javascript:billAmout(this);"/></li>
     	<li><html:input type="text" id="ItemUnit" name="ItemUnit" property="ItemUnit" size="10" maxlength="255"/></li>
     	<li><html:input type="text" id="ItemQuantity" name="ItemQuantity" property="ItemQuantity" size="10" maxlength="255" onchange="javascript:billAmout(this);"/></li>
     	<li><html:input type="text" id="BillAmount" name="BillAmount" property="BillAmount" size="10" maxlength="255"/></li>
	<li><html:output property="Currency"/> <html:input type="hidden" id="Currency" name="Currency" property="Currency"/></li>
...
<logic:iterate property="List">
        <li><html:input type="checkbox" id="SelectItem" name="SelectItem" value="<%=""+i%>"  onclick="javascript:checkAll(this);"/><html:output property="<%="Account"+i%>"/><html:input type="hidden" id="<%="AccountID"+i%>" name="<%="AccountID"+i%>" property="<%="AccountID"+i%>"/></li>
        <li><html:output property="<%="ItemName"+i%>"/> <html:input type="hidden" id="<%="ItemName"+i%>" name="<%="ItemName"+i%>" property="<%="ItemName"+i%>"/> </li>
        <li><html:output property="<%="ItemRate"+i%>"/> <html:input type="hidden" id="<%="ItemRate"+i%>" name="<%="ItemRate"+i%>" property="<%="ItemRate"+i%>"/> </li>
        <li><html:output property="<%="ItemUnit"+i%>"/> <html:input type="hidden" id="<%="ItemUnit"+i%>" name="<%="ItemUnit"+i%>" property="<%="ItemUnit"+i%>"/> </li>
        <li><html:output property="<%="ItemQuantity"+i%>"/> <html:input type="hidden" id="<%="ItemQuantity"+i%>" name="<%="ItemQuantity"+i%>" property="<%="ItemQuantity"+i%>"/> </li>
        <li><html:output property="<%="BillAmount"+i%>"/> <html:input type="hidden" id="<%="BillAmount"+i%>" name="<%="BillAmount"+i%>" property="<%="BillAmount"+i%>"/> </li>
	<li><html:output property="<%="Currency"+i%>"/> <html:input type="hidden" id="<%="CurrencyID"+i%>" name="<%="CurrencyID"+i%>" property="<%="CurrencyID"+i%>"/></li>
<% i++; %>
</logic:iterate>
      </ul>
    </div>
