...
<meta name="revision" content="$Id: editDownload.jsp,v 1.5 2008/09/02 19:17:10 zlei Exp $" />
...
<form id="default" name="default" Method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/Download.do?state=processUpdate">
...
<td><input type="file" id="DownloadPath" name="DownloadPath" property="DownloadPath"/></td>
</tr>
