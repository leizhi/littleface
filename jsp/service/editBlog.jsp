...
<meta name="revision" content="$Id: editBlog.jsp,v 1.2 2008/09/03 23:13:41 cvs Exp $" />
...
<form id="default" name="default" Method="post" action="<%=request.getContextPath()%>/Blog.do?state=processUpdateBlog">
