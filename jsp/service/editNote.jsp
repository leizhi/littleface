...
<!-- SearchTable -->
	...
	<li class="Input"><html:output id="NoteNo" name="NoteNo" property="NoteNo"/>	<html:input type="hidden" id="NoteNo" name="NoteNo" property="NoteNo"/></li>
        ...
        <li class="Input"> <html:input type="text" id="DueDate" name="DueDate" property="DueDate" size="15" maxlength="255"/> <a href="javascript:Util.Calendar('DueDate')"><img src="../etc/images/miniDate.gif" border=0 alt="<html:message key="ChooseDate"/>"></a></li>
...
<!-- ListTable -->
    <div class="Table7" >
      <ul>
     	...
     	<li><html:input type="text" id="ItemRate" name="ItemRate" property="ItemRate" size="10" maxlength="255"/></li>
     	<li><html:input type="text" id="ItemUnit" name="ItemUnit" property="ItemUnit" size="10" maxlength="255"/></li>
     	<li><html:input type="text" id="ItemQuantity" name="ItemQuantity" property="ItemQuantity" size="10" maxlength="255"/></li>
...
<logic:iterate property="List">
        <li><html:input type="checkbox" id="<%="ID"+i%>" name="<%="ID"+i%>" value="<%=Input.getValue("ID"+i)%>"/><%=Input.getValue("Account"+i)%></li>
